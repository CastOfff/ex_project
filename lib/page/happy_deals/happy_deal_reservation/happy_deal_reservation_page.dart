...
import '../../reservation/sheet/confirm_reservation_sheet.dart';
import 'date_reservation_picked.dart';

class HappyDealReservationPage extends StatefulWidget {
  final HappyDeal happyDeal;

  const HappyDealReservationPage({super.key, required this.happyDeal});
                            ...
                            child: Column(children: [
                              const Padding(
                                padding: EdgeInsets.only(
                                    left: 22.0, right: 22, top: 26, bottom: 10),
                                child: Align(
                              ...
                              Container(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: DropdownButton(
                                      ...
                                      value: widget.happyDeal
                                          .restaurants[selectedRestaurant].name,
                                      isExpanded: true,
                                      items: widget.happyDeal.restaurants
                                          .map((restaurant) {
                                      ...
                                      onChanged: (newValue) {
                                        setState(() {
                                          selectedRestaurant = widget
                                              .happyDeal.restaurants
                                            ...
                                            if (agree &&
                                              ...
                                              showBottomSheet(
                                                ...
                                                builder: (context) {
                                                  ...
                                                  reservationHistoryDetail =
                                                  randomReservationHistoryDetail();
                                                  return ConfirmReservationSheet(
                                                    address:
                                                    '${widget.happyDeal.restaurants[selectedRestaurant].address}',
                                                    nameRestaurant:
                                                    '${widget.happyDeal.restaurants[selectedRestaurant].name}',
                                                    restaurantId:
                                                    '${widget.happyDeal.restaurants[selectedRestaurant].id}',
                                                    time: _selectedTime ?? '',
                                                    date: selectedDate,
                                                    people: people,
                                              ...
                                              ScaffoldMessenger.of(context)
                                                ...
                                                const SnackBar(
                                                  content: Text(
                                                      'Please vaccine with terms of service'),
                                                ),
                                              );
                                            }
                                          });
