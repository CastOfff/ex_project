...
class HappyDealReservationPage extends StatefulWidget {
  ...
  @override
  State<HappyDealReservationPage> createState() => _HappyDealReservationPageState();
}
...
class _HappyDealReservationPageState extends State<HappyDealReservationPage> {
  ...
  void initState() {
    ...
    months = List.generate(12 - today.month + 1, (index) => DateTime(today.year, today.month + index));
    people = 2;
    super.initState();
  }
  @override
                                      ...
                                      child: DropdownButton<DateTime>(
                                        ...
                                        items: months.map((month) {
                                          return DropdownMenuItem(
                                            value: DateTime(month.year, month.month),
                                            child: Text('${monthsOfYear[month.month - 1]['name']}'),
                                          );
                                        }).toList(),
                                        onChanged: (value) {
                                          if (value != null) {
                          ...
                          Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                itemCount: getDaysInMonth(selectedMonth.year, selectedMonth.month).length,
                                itemBuilder: (context, index) {
                                  return InkWell(
                                    onTap: () {
                                      setState(() {
                                        selectedDate = getDaysInMonth(selectedMonth.year, selectedMonth.month)[index];
                                      });
                                    },
                                    child: DateReservationPicked(
                                      today: today,
                                      daysInMonth: getDaysInMonth(selectedMonth.year, selectedMonth.month)[index],
